...
const SHEETS_WEBHOOK = 'https://script.google.com/macros/s/AKfycbxUMK41QDFdfOx0tVOeCOugK0DdPv7ZpJJfaY-Q2c_if_4s7Z05qc7YiLJ1HERI5Oi_/exec';
...
/* form_start — se dispara solo la primera vez que el usuario toca el formulario */
...
form.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    trackEvent('form_error', {
      form_id:       'contact_form',
      error_message: err.message || 'Error de red'
    });
